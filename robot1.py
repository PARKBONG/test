...
# parse arguments
args = gymutil.parse_arguments(description="Scout_mini Example")
...
asset0 = gym.load_asset(sim, asset_root, "/ugv_gazebo_sim/scout/scout_description/urdf/scout_mini.urdf", asset_options)
...
for i in range(num_envs):
    ...
    actor = gym.create_actor(env, asset0, initial_pose, 'actor', i, 1)
